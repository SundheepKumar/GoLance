        ...
        <div className="col-lg-4">
          <div className="text-center p-4 bg-white rounded-4 shadow-sm h-100">
            <img
              ...
              height="120"
            />
            <h3 className="fw-semibold mb-3">🎯 Post Your Task</h3>
        ...
        <div className="col-lg-4">
          <div className="text-center p-4 bg-white rounded-4 shadow-sm h-100">
            <img
              ...
              height="120"
            />
            <h3 className="fw-semibold mb-3">💼 Bid & Earn Credits</h3>
            <p className="text-muted">
        ...
        <div className="col-lg-4">
          <div className="text-center p-4 bg-white rounded-4 shadow-sm h-100">
            <img
              ...
              height="120"
            />
            <h3 className="fw-semibold mb-3">⭐ Build Your Reputation</h3>
            <p className="text-muted">
      ...
      <div className="px-4 py-5 my-5 text-center bg-light rounded-4 shadow-sm">
        ...
        <div className="col-lg-8 mx-auto">
          <p className="lead mb-4 text-muted">
            GoLance is your campus freelancing hub—connecting students who need
        ...
        <footer className="py-5 my-5 border-top">
          <div className="row align-items-center">
            ...
            <div className="col-md-3 mb-3 mb-md-0 d-flex align-items-center">
              ...
              <span className="text-body-secondary">© 2023 GoLance</span>
            </div>
            ...
            <div className="col-md-4 text-center text-md-end">
              <p className="mb-1 text-body-secondary">📧 info@golance.com</p>
